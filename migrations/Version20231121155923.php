 ...
 */
final class Version20231121155923 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE vetement (id INT AUTO_INCREMENT NOT NULL, categorie_id INT DEFAULT NULL, marque_id INT DEFAULT NULL, taille_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, image_url VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, INDEX IDX_3CB446CFBCF5E72D (categorie_id), INDEX IDX_3CB446CF4827B9B2 (marque_id), INDEX IDX_3CB446CFFF25611A (taille_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE vetement ADD CONSTRAINT FK_3CB446CFFF25611A FOREIGN KEY (taille_id) REFERENCES taille (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vetement DROP FOREIGN KEY FK_3CB446CFFF25611A');
